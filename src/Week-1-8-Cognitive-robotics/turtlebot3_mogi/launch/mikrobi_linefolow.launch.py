...
#
# Authors: Joep Tool, Modified by [Your Name]
...
def generate_launch_description():
    ...
    # Add the gazebo_models directory to GZ_SIM_RESOURCE_PATH
    os.environ["GZ_SIM_RESOURCE_PATH"] += os.pathsep + os.path.join(pkg_turtlebot3_mogi, "gazebo_models")
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='track_world.sdf',
    ...
    set_env_vars_resources = AppendEnvironmentVariable(
        ...
        os.path.join(pkg_turtlebot3_mogi, 'gazebo_models')
    )
    ...
    params_file_arg = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.expanduser('~/ros2_ws/src/turtlebot3_slam_toolbox/config/slam_config.yaml'),
        description='Full path to the ROS2 parameters file to use for slam_toolbox'
    )

    # Add SLAM Toolbox online_async_launch.py
    ...
    # Add line_mapper node
    line_mapper_node = Node(
        package='line_mapper_pkg',
    ...
    ld.add_action(line_mapper_node)
